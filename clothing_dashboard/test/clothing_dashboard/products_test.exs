defmodule ClothingDashboard.ProductsTest do
  use ClothingDashboard.DataCase

  alias ClothingDashboard.Products

  describe "products" do
    alias ClothingDashboard.Products.Product

    import ClothingDashboard.ProductsFixtures
